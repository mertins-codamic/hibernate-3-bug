...
@Setter
@MappedSuperclass
public abstract class UserSingletonModel extends AbstractModel {
  /**
   * unique field. id of object owner. Once set, no update should be possible.
   */
  @Column(name = "_ownerId", nullable = false, updatable = false, unique = true)
